...
def test_sphire_plot_deg_linear():
    plot = True
    typ = 'sphire'
    name = 'bdb:stack'
    index = 'index.txt'
...
def test_sphire_no_plot_deg_linear():
    plot = False
    typ = 'sphire'
    name = 'bdb:stack'
    index = 'index.txt'
...
def test_sphire_no_plot_std_linear():
    plot = False
    typ = 'sphire'
    name = 'bdb:stack'
    index = 'index.txt'
...
if __name__ == '__main__':
    try:
        ...
        pass
    test_sphire_plot_deg_linear()
    test_sphire_no_plot_deg_linear()
    test_sphire_plot_std_linear()
    test_sphire_no_plot_std_linear()
